...
/* Obtenho o nome do contexto da aplicacao */
$texto = $_SERVER['DOCUMENT_ROOT'];
$posicao = strpos($texto, 'webapps');
$saida = substr($texto, $posicao + 7);
/* By Erivando 4-2-2011 */

$baseUrl = 'http://' . $_SERVER['HTTP_HOST'] . $saida . 'ckfinder/userfiles/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = $_SERVER['DOCUMENT_ROOT'] . 'ckfinder/userfiles/';
